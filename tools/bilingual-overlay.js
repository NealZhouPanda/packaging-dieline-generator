(() => {
  const exact = new Map([
    ...
    ["当前开放 5 款箱型结构", "Five box styles available"],
    ...
    ["放不下", "Too big"],
    ["01 · 标准纸箱", "01 · Standard carton"],
    ["02 · 翻盖展示盒", "02 · Flip-top display box"],
    ["03 · 翻盖飞机盒", "03 · Flip-top mailer"],
    ["04 · 翻盖锁扣纸盒", "04 · Flip-top lock carton"],
    ["05 · 提手盒", "05 · Handle box"],
    ...
    ["导入 PNG、JPG、SVG 或 PDF，贴图会同步到 3D；PDF 默认使用第 1 页。", "Import PNG, JPG, SVG, or PDF; artwork syncs to 3D. PDFs use page 1 by default."],
    ["支持 PNG、JPG、SVG 或 PDF 贴图文件。", "PNG, JPG, SVG, and PDF artwork files are supported."],
    ["图片与 PDF 均使用完整刀模画布定位；PDF 默认导入第 1 页。", "Images and PDFs use the full dieline canvas; PDFs import page 1 by default."],
