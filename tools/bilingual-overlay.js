(() => {
  const exact = new Map([
    ...
    ["当前开放 0201、0421、K016A、E005C 与 C001GX 五款结构", "Five box styles available: 0201, 0421, K016A, E005C, C001GX"],
    ...
    ["0421 · 翻盖展示盒", "0421 · Flip-top display box"],
    ["K016A · 提手盒", "K016A · Handle box"],
    ["0427 · 翻盖飞机盒", "0427 · Flip-top mailer"],
    ["C001GX · 翻盖锁扣纸盒", "C001GX · Flip-top lock carton"],
